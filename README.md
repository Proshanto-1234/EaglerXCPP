...
## Program build and runtime targets / Project Settings
* **Platform**: Windows
* **Compiler type**: MSVC latest 64-bit
* **Build Options**: Multi-Threaded, Static Release binary. Optimization level will be "Favour Speed"
